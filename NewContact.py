...
class NewContact(unittest.TestCase):
    ...
    def fill_company_information(self, wd):
    ...
    def fill_contact_information(self, wd):
    ...
    def fill_email_information(self, wd):
    ...
    def fill_dates_contact(self, wd):
    ...
    def fill_home_information(self, wd):
    ...
    def test_NewContact(self):
        ...
        self.fill_name_contact(wd)
        self.fill_company_information(wd)
        self.fill_contact_information(wd)
        self.fill_email_information(wd)
        self.fill_homepage(wd)
        self.fill_dates_contact(wd)
        self.fill_home_information(wd)
